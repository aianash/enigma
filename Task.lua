...
---------------------------------------
local Task = klazz('enigma.Task')
Task.isTask = true

local ItemTypes = import 'enigma.ItemTypes'

--
function Task:__init(name, desc, cmdOpt)
   if type(name) ~= 'string' then error('Task name should be provided') end
...
function Task:print()
   ...
   if type(self.description) == 'string' then print(self.description) end
